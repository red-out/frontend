...
const LastCashbacks: React.FC = () => {
  ...
  const handleDetailsClick = (orderId: number) => {
    navigate(`/monthly_cashbacks?draft_order_id=${orderId}`, {
      state: { readonly: true },
    });
  };
...
// // Сопоставление числового значения месяца с его названием
// const monthNames: { [key: string]: string } = {
//   "01": "Январь",
//   "02": "Февраль",
//   "03": "Март",
...
//   useEffect(() => {
//     let didCancel = false; // Флаг для предотвращения повторных запросов
